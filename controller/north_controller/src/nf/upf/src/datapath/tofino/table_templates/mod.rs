...
pub trait PipelineTemplate {
	...
	fn generate_upf_driver_update_update(&self, old_ma_id: u32, new_ma_id: u32, global_qer_id: u16) -> upf_driver_interface::PDRUpdate;
...
impl MatchInstance {
	...
	pub fn generate_upf_driver_update_update(&self, old_ma_id: u32, new_ma_id: u32, global_qer_id: u16) -> Option<upf_driver_interface::PDRUpdate> {
		match self {
			MatchInstance::UplinkToN6Simple(x) => Some(x.generate_upf_driver_update_update(old_ma_id, new_ma_id, global_qer_id)),
			MatchInstance::UplinkToN6Complex(_) => todo!(),
			MatchInstance::UplinkToN9Simple(_) => todo!(),
			MatchInstance::UplinkToN9Complex(_) => todo!(),
			MatchInstance::DownlinkFromN6Simple(x) => Some(x.generate_upf_driver_update_update(old_ma_id, new_ma_id, global_qer_id)),
			MatchInstance::DownlinkFromN6Complex(_) => todo!(),
			MatchInstance::DownlinkFromN9Simple(_) => todo!(),
			MatchInstance::DoNothing(_) => None,
		}
