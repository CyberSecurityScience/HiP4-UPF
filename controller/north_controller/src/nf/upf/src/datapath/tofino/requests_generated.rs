...
pub const ENUM_VALUES_REQUEST_UNION: [RequestUnion; 8] = [
  ...
  RequestUnion::InsertOrUpdatePerMaidURR,
];
...
impl RequestUnion {
  ...
  pub const InsertOrUpdatePerMaidURR: Self = Self(7);
  ...
  pub fn variant_name(self) -> Option<&'static str> {
    match self {
      ...
      Self::InsertOrUpdatePerMaidURR => Some("InsertOrUpdatePerMaidURR"),
      _ => None,
    }
  }
}
...
pub enum RequestUnionT {
  ...
  InsertOrUpdatePerMaidURR(Box<InsertOrUpdatePerMaidURRT>),
}
...
impl RequestUnionT {
  pub fn request_union_type(&self) -> RequestUnion {
    match self {
      ...
      Self::InsertOrUpdatePerMaidURR(_) => RequestUnion::InsertOrUpdatePerMaidURR,
    }
  }
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(&self, fbb: &mut flatbuffers::FlatBufferBuilder<'b, A>) -> Option<flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>> {
    match self {
      ...
      Self::InsertOrUpdatePerMaidURR(v) => Some(v.pack(fbb).as_union_value()),
    }
  }
  ...
  /// If the union variant matches, return the owned InsertOrUpdatePerMaidURRT, setting the union to NONE.
  pub fn take_insert_or_update_per_maid_urr(&mut self) -> Option<Box<InsertOrUpdatePerMaidURRT>> {
    if let Self::InsertOrUpdatePerMaidURR(_) = self {
      let v = core::mem::replace(self, Self::NONE);
      if let Self::InsertOrUpdatePerMaidURR(w) = v {
        Some(w)
      } else {
        unreachable!()
      }
  ...
  /// If the union variant matches, return a reference to the InsertOrUpdatePerMaidURRT.
  pub fn as_insert_or_update_per_maid_urr(&self) -> Option<&InsertOrUpdatePerMaidURRT> {
    if let Self::InsertOrUpdatePerMaidURR(v) = self { Some(v.as_ref()) } else { None }
  }
  /// If the union variant matches, return a mutable reference to the InsertOrUpdatePerMaidURRT.
  pub fn as_insert_or_update_per_maid_urr_mut(&mut self) -> Option<&mut InsertOrUpdatePerMaidURRT> {
    if let Self::InsertOrUpdatePerMaidURR(v) = self { Some(v.as_mut()) } else { None }
  }
}
...
pub enum InsertOrUpdatePerMaidURROffset {}
#[derive(Copy, Clone, PartialEq)]

pub struct InsertOrUpdatePerMaidURR<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for InsertOrUpdatePerMaidURR<'a> {
  type Inner = InsertOrUpdatePerMaidURR<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> InsertOrUpdatePerMaidURR<'a> {
  pub const VT_MA_ID: flatbuffers::VOffsetT = 4;
  pub const VT_VOL_THRES: flatbuffers::VOffsetT = 6;
  pub const VT_VOL_THRES_ID: flatbuffers::VOffsetT = 8;
  pub const VT_TIME_THRES: flatbuffers::VOffsetT = 10;
  pub const VT_PERIOD_VAL: flatbuffers::VOffsetT = 12;
  pub const VT_FLAGS: flatbuffers::VOffsetT = 14;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    InsertOrUpdatePerMaidURR { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args InsertOrUpdatePerMaidURRArgs
  ) -> flatbuffers::WIPOffset<InsertOrUpdatePerMaidURR<'bldr>> {
    let mut builder = InsertOrUpdatePerMaidURRBuilder::new(_fbb);
    builder.add_period_val(args.period_val);
    builder.add_time_thres(args.time_thres);
    builder.add_vol_thres(args.vol_thres);
    builder.add_vol_thres_id(args.vol_thres_id);
    builder.add_ma_id(args.ma_id);
    builder.add_flags(args.flags);
    builder.finish()
  }

  pub fn unpack(&self) -> InsertOrUpdatePerMaidURRT {
    let ma_id = self.ma_id();
    let vol_thres = self.vol_thres();
    let vol_thres_id = self.vol_thres_id();
    let time_thres = self.time_thres();
    let period_val = self.period_val();
    let flags = self.flags();
    InsertOrUpdatePerMaidURRT {
      ma_id,
      vol_thres,
      vol_thres_id,
      time_thres,
  ...
  pub fn ma_id(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(InsertOrUpdatePerMaidURR::VT_MA_ID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn vol_thres(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(InsertOrUpdatePerMaidURR::VT_VOL_THRES, Some(0)).unwrap()}
  }
  #[inline]
  pub fn vol_thres_id(&self) -> u32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(InsertOrUpdatePerMaidURR::VT_VOL_THRES_ID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn time_thres(&self) -> u64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(InsertOrUpdatePerMaidURR::VT_TIME_THRES, Some(0)).unwrap()}
  }
  #[inline]
  pub fn period_val(&self) -> u64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(InsertOrUpdatePerMaidURR::VT_PERIOD_VAL, Some(0)).unwrap()}
  }
  #[inline]
  pub fn flags(&self) -> u8 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u8>(InsertOrUpdatePerMaidURR::VT_FLAGS, Some(0)).unwrap()}
  }
}

impl flatbuffers::Verifiable for InsertOrUpdatePerMaidURR<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<u32>("vol_thres_id", Self::VT_VOL_THRES_ID, false)?
     .visit_field::<u64>("time_thres", Self::VT_TIME_THRES, false)?
     .visit_field::<u64>("period_val", Self::VT_PERIOD_VAL, false)?
     .visit_field::<u8>("flags", Self::VT_FLAGS, false)?
     .finish();
    Ok(())
  }
}
pub struct InsertOrUpdatePerMaidURRArgs {
    pub ma_id: u32,
    pub vol_thres: u64,
    pub vol_thres_id: u32,
    pub time_thres: u64,
    pub period_val: u64,
    pub flags: u8,
}
impl<'a> Default for InsertOrUpdatePerMaidURRArgs {
  #[inline]
  fn default() -> Self {
    InsertOrUpdatePerMaidURRArgs {
      ma_id: 0,
      vol_thres: 0,
      vol_thres_id: 0,
      time_thres: 0,
...
pub struct InsertOrUpdatePerMaidURRBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> InsertOrUpdatePerMaidURRBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_ma_id(&mut self, ma_id: u32) {
    self.fbb_.push_slot::<u32>(InsertOrUpdatePerMaidURR::VT_MA_ID, ma_id, 0);
  }
  #[inline]
  pub fn add_vol_thres(&mut self, vol_thres: u64) {
    self.fbb_.push_slot::<u64>(InsertOrUpdatePerMaidURR::VT_VOL_THRES, vol_thres, 0);
  }
  #[inline]
  pub fn add_vol_thres_id(&mut self, vol_thres_id: u32) {
    self.fbb_.push_slot::<u32>(InsertOrUpdatePerMaidURR::VT_VOL_THRES_ID, vol_thres_id, 0);
  }
  #[inline]
  pub fn add_time_thres(&mut self, time_thres: u64) {
    self.fbb_.push_slot::<u64>(InsertOrUpdatePerMaidURR::VT_TIME_THRES, time_thres, 0);
  }
  #[inline]
  pub fn add_period_val(&mut self, period_val: u64) {
    self.fbb_.push_slot::<u64>(InsertOrUpdatePerMaidURR::VT_PERIOD_VAL, period_val, 0);
  }
  #[inline]
  pub fn add_flags(&mut self, flags: u8) {
    self.fbb_.push_slot::<u8>(InsertOrUpdatePerMaidURR::VT_FLAGS, flags, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> InsertOrUpdatePerMaidURRBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    InsertOrUpdatePerMaidURRBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<InsertOrUpdatePerMaidURR<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for InsertOrUpdatePerMaidURR<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("InsertOrUpdatePerMaidURR");
      ds.field("ma_id", &self.ma_id());
      ds.field("vol_thres", &self.vol_thres());
      ds.field("vol_thres_id", &self.vol_thres_id());
      ds.field("time_thres", &self.time_thres());
      ds.field("period_val", &self.period_val());
...
#[non_exhaustive]
#[derive(Debug, Clone, PartialEq)]
pub struct InsertOrUpdatePerMaidURRT {
  pub ma_id: u32,
  pub vol_thres: u64,
  pub vol_thres_id: u32,
  pub time_thres: u64,
...
impl Default for InsertOrUpdatePerMaidURRT {
  fn default() -> Self {
    Self {
      ma_id: 0,
      vol_thres: 0,
...
impl InsertOrUpdatePerMaidURRT {
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
    &self,
    _fbb: &mut flatbuffers::FlatBufferBuilder<'b, A>
  ) -> flatbuffers::WIPOffset<InsertOrUpdatePerMaidURR<'b>> {
    let ma_id = self.ma_id;
    let vol_thres = self.vol_thres;
    let vol_thres_id = self.vol_thres_id;
    let time_thres = self.time_thres;
    let period_val = self.period_val;
    let flags = self.flags;
    InsertOrUpdatePerMaidURR::create(_fbb, &InsertOrUpdatePerMaidURRArgs{
      ma_id,
      vol_thres,
      vol_thres_id,
      time_thres,
...
impl<'a> Request<'a> {
  ...
  pub fn unpack(&self) -> RequestT {
    let request = match self.request_type() {
      ...
      RequestUnion::InsertOrUpdatePerMaidURR => RequestUnionT::InsertOrUpdatePerMaidURR(Box::new(
        self.request_as_insert_or_update_per_maid_urr()
            .expect("Invalid union table, expected `RequestUnion::InsertOrUpdatePerMaidURR`.")
            .unpack()
      )),
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn request_as_insert_or_update_per_maid_urr(&self) -> Option<InsertOrUpdatePerMaidURR<'a>> {
    if self.request_type() == RequestUnion::InsertOrUpdatePerMaidURR {
      self.request().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { InsertOrUpdatePerMaidURR::init_from_table(t) }
     })
    } else {
      None
    }
    ...
    v.visit_table(pos)?
     .visit_union::<RequestUnion, _>("request_type", Self::VT_REQUEST_TYPE, "request", Self::VT_REQUEST, false, |key, v, pos| {
        match key {
          ...
          RequestUnion::InsertOrUpdatePerMaidURR => v.verify_union_variant::<flatbuffers::ForwardsUOffset<InsertOrUpdatePerMaidURR>>("RequestUnion::InsertOrUpdatePerMaidURR", pos),
          _ => Ok(()),
        }
     })?
     .finish();
  ...
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("Request");
      ...
      match self.request_type() {
        ...
        RequestUnion::InsertOrUpdatePerMaidURR => {
          if let Some(x) = self.request_as_insert_or_update_per_maid_urr() {
            ds.field("request", &x)
          } else {
            ds.field("request", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
