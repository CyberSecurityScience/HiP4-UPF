...
#define TABLE_SIZE_UL_N6_SIMPLE_IPV4 (<%VALUE_SIMPLE%> - (2 * 1024))
#define TABLE_SIZE_UL_N6_COMPLEX_IPV4 ((<%VALUE_COMPLEX%>) >> 1)

#define TABLE_SIZE_UL_N9_SIMPLE_IPV4 2 * 1024
#define TABLE_SIZE_UL_N9_COMPLEX_IPV4 ((<%VALUE_COMPLEX%>) >> 1)


#define TABLE_SIZE_DL_N6_SIMPLE_IPV4 (<%VALUE_SIMPLE%> - (2 * 1024))
#define TABLE_SIZE_DL_N6_COMPLEX_IPV4 ((<%VALUE_COMPLEX%>) >> 1)
