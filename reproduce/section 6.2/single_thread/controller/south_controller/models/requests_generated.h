...
struct SetMaidVolThreshold;
struct SetMaidVolThresholdBuilder;
struct SetMaidVolThresholdT;
...
enum RequestUnion : uint8_t {
  ...
  RequestUnion_SetMaidVolThreshold = 7,
  RequestUnion_MIN = RequestUnion_NONE,
  RequestUnion_MAX = RequestUnion_SetMaidVolThreshold
};
...
inline const RequestUnion (&EnumValuesRequestUnion())[8] {
  static const RequestUnion values[] = {
    ...
    RequestUnion_SetMaidVolThreshold
  };
  return values;
}
...
inline const char *EnumNameRequestUnion(RequestUnion e) {
  if (::flatbuffers::IsOutRange(e, RequestUnion_NONE, RequestUnion_SetMaidVolThreshold)) return "";
...
template<> struct RequestUnionTraits<UPFDriver::Requests::SetMaidVolThreshold> {
  static const RequestUnion enum_value = RequestUnion_SetMaidVolThreshold;
};
...
template<> struct RequestUnionUnionTraits<UPFDriver::Requests::SetMaidVolThresholdT> {
  static const RequestUnion enum_value = RequestUnion_SetMaidVolThreshold;
};
...
struct RequestUnionUnion {
  ...
  UPFDriver::Requests::SetMaidVolThresholdT *AsSetMaidVolThreshold() {
    return type == RequestUnion_SetMaidVolThreshold ?
      reinterpret_cast<UPFDriver::Requests::SetMaidVolThresholdT *>(value) : nullptr;
  }
  const UPFDriver::Requests::SetMaidVolThresholdT *AsSetMaidVolThreshold() const {
    return type == RequestUnion_SetMaidVolThreshold ?
      reinterpret_cast<const UPFDriver::Requests::SetMaidVolThresholdT *>(value) : nullptr;
  }
};
...
struct DL_N6_SimpleInsertRequestBuilder {
  ...
  void add_vol_thres(uint64_t vol_thres) {
    fbb_.AddElement<uint64_t>(DL_N6_SimpleInsertRequest::VT_VOL_THRES, vol_thres, 0);
  }
...
struct DL_N6_SimpleUpdateRequestBuilder {
  ...
  void add_vol_thres(uint64_t vol_thres) {
    fbb_.AddElement<uint64_t>(DL_N6_SimpleUpdateRequest::VT_VOL_THRES, vol_thres, 0);
  }
...
struct UL_N6_SimpleInsertRequestBuilder {
  ...
  void add_vol_thres(uint64_t vol_thres) {
    fbb_.AddElement<uint64_t>(UL_N6_SimpleInsertRequest::VT_VOL_THRES, vol_thres, 0);
  }
...
struct UL_N6_SimpleUpdateRequestBuilder {
  ...
  void add_vol_thres(uint64_t vol_thres) {
    fbb_.AddElement<uint64_t>(UL_N6_SimpleUpdateRequest::VT_VOL_THRES, vol_thres, 0);
  }
...
struct SetMaidVolThresholdT : public ::flatbuffers::NativeTable {
  typedef SetMaidVolThreshold TableType;
  uint32_t ma_id = 0;
  uint64_t bytes = 0;
};

struct SetMaidVolThreshold FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SetMaidVolThresholdT NativeTableType;
  typedef SetMaidVolThresholdBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_MA_ID = 4,
    VT_BYTES = 6
  };
  ...
  SetMaidVolThresholdT *UnPack(const ::flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(SetMaidVolThresholdT *_o, const ::flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static ::flatbuffers::Offset<SetMaidVolThreshold> Pack(::flatbuffers::FlatBufferBuilder &_fbb, const SetMaidVolThresholdT* _o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
};

struct SetMaidVolThresholdBuilder {
  typedef SetMaidVolThreshold Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_ma_id(uint32_t ma_id) {
    fbb_.AddElement<uint32_t>(SetMaidVolThreshold::VT_MA_ID, ma_id, 0);
  }
  void add_bytes(uint64_t bytes) {
    fbb_.AddElement<uint64_t>(SetMaidVolThreshold::VT_BYTES, bytes, 0);
  }
  explicit SetMaidVolThresholdBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SetMaidVolThreshold> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SetMaidVolThreshold>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SetMaidVolThreshold> CreateSetMaidVolThreshold(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    uint32_t ma_id = 0,
    uint64_t bytes = 0) {
  SetMaidVolThresholdBuilder builder_(_fbb);
  builder_.add_bytes(bytes);
  builder_.add_ma_id(ma_id);
  return builder_.Finish();
}

::flatbuffers::Offset<SetMaidVolThreshold> CreateSetMaidVolThreshold(::flatbuffers::FlatBufferBuilder &_fbb, const SetMaidVolThresholdT *_o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
struct Request FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const UPFDriver::Requests::SetMaidVolThreshold *request_as_SetMaidVolThreshold() const {
    return request_type() == UPFDriver::Requests::RequestUnion_SetMaidVolThreshold ? static_cast<const UPFDriver::Requests::SetMaidVolThreshold *>(request()) : nullptr;
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
template<> inline const UPFDriver::Requests::SetMaidVolThreshold *Request::request_as<UPFDriver::Requests::SetMaidVolThreshold>() const {
  return request_as_SetMaidVolThreshold();
}
...
inline SetMaidVolThresholdT *SetMaidVolThreshold::UnPack(const ::flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<SetMaidVolThresholdT>(new SetMaidVolThresholdT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}

inline void SetMaidVolThreshold::UnPackTo(SetMaidVolThresholdT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
...
inline ::flatbuffers::Offset<SetMaidVolThreshold> SetMaidVolThreshold::Pack(::flatbuffers::FlatBufferBuilder &_fbb, const SetMaidVolThresholdT* _o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  return CreateSetMaidVolThreshold(_fbb, _o, _rehasher);
}

inline ::flatbuffers::Offset<SetMaidVolThreshold> CreateSetMaidVolThreshold(::flatbuffers::FlatBufferBuilder &_fbb, const SetMaidVolThresholdT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { ::flatbuffers::FlatBufferBuilder *__fbb; const SetMaidVolThresholdT* __o; const ::flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _ma_id = _o->ma_id;
  auto _bytes = _o->bytes;
  return UPFDriver::Requests::CreateSetMaidVolThreshold(
      _fbb,
      _ma_id,
      _bytes);
}
...
inline bool VerifyRequestUnion(::flatbuffers::Verifier &verifier, const void *obj, RequestUnion type) {
  switch (type) {
    ...
    case RequestUnion_SetMaidVolThreshold: {
      auto ptr = reinterpret_cast<const UPFDriver::Requests::SetMaidVolThreshold *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default: return true;
  }
...
inline ::flatbuffers::Offset<void> RequestUnionUnion::Pack(::flatbuffers::FlatBufferBuilder &_fbb, const ::flatbuffers::rehasher_function_t *_rehasher) const {
  ...
  switch (type) {
    ...
    case RequestUnion_SetMaidVolThreshold: {
      auto ptr = reinterpret_cast<const UPFDriver::Requests::SetMaidVolThresholdT *>(value);
      return CreateSetMaidVolThreshold(_fbb, ptr, _rehasher).Union();
    }
    default: return 0;
  }
}
...
inline RequestUnionUnion::RequestUnionUnion(const RequestUnionUnion &u) : type(u.type), value(nullptr) {
  switch (type) {
    ...
    case RequestUnion_SetMaidVolThreshold: {
      value = new UPFDriver::Requests::SetMaidVolThresholdT(*reinterpret_cast<UPFDriver::Requests::SetMaidVolThresholdT *>(u.value));
      break;
    }
    default:
      break;
...
inline void RequestUnionUnion::Reset() {
  switch (type) {
    ...
    case RequestUnion_SetMaidVolThreshold: {
      auto ptr = reinterpret_cast<UPFDriver::Requests::SetMaidVolThresholdT *>(value);
      delete ptr;
      break;
    }
    default: break;
