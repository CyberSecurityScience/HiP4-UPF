...
use datapath::{BackendInterface, BackendSettings, BackendReport, tofino::{qos::QosQfiDataYaml, URRTestAuxSettings}};
...
struct Config_upf {
	...
	pub urr_cfg: URRTestAuxSettings,
