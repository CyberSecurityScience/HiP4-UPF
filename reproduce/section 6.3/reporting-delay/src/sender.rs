...
impl GtpClient {
    ...
    pub fn craft_and_send(&self, ue: &UE, payload_size: usize) {
        ...
        payload[16..16 + 20].clone_from_slice(&[0x45, 0x00, 0x00, 0x54, 0x01, 0x39, 0x40, 0x00, 0x3f, 0x11, 0x26, 0x2e, ue_ip[0], ue_ip[1], ue_ip[2], ue_ip[3], 0x0c, 0x01, 0x01, 0x02]);
